...
from workmanager.request_utils import route_base_request, route_specific_request, Http404, JsonResponse, no_method_for_resouce, no_items_found
from workmanager.models import Team, Task


def handle_base_request(request: HttpRequest) -> HttpResponse:
    ...
    """
    return route_base_request(request, get, create)
...
def create(body: dict):
    ...
    if len(body) > 0:
        ...
        raise IntegrityError("team.name")
